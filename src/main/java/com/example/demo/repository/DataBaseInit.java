 ...
 * import com.example.demo.entity.CompteCourant; import
 * com.example.demo.entity.CompteEpargne; import
 * com.example.demo.entity.Conseiller; import
 ...
 * 
 * conseiller.setLogin("JD"); conseiller.setPassword("1234");
 * conseiller.setGradeGerant(false);
 * 
 * Agence agence = agenceService.createAgence("Marie Dupond");
 * 
 * Client client1 = new Client("Client 1"); Client client2 = new
 * Client("Client 2");
 * 
 ...
 * 
 * CompteCourant CompteC1 = new CompteCourant("cc", "0123", -6000,
 * LocalDate.now()); CompteCourant CompteC2 = new CompteCourant("cc", "0124",
 * 6000, LocalDate.now()); CompteEpargne CompteE1 = new CompteEpargne("ce",
 * "0125", -6000, LocalDate.now()); CompteEpargne CompteE2 = new
 * CompteEpargne("ce", "0126", 6000, LocalDate.now());
 * 
 * CompteC1.setClient(client1); CompteC2.setClient(client2);
 * CompteE1.setClient(client1); CompteE2.setClient(client2);
 * 
 * client1.setCompteCourant(CompteC1); client1.setCompteEpargne(CompteE1);
 * 
 * client2.setCompteCourant(CompteC2); client2.setCompteEpargne(CompteE2);
 * 
